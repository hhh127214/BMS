...
echo.
echo ============================================
echo 1/21 01\  B组 strategy server (gcc)
echo ============================================
call 01\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 2/21 02\  A组 safety mgr demo (g++)
echo ============================================
call 02\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 3/21 02\  A组 safety unit tests (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 10/21 05\ 周期5 安全约束引擎 (g++)
echo ============================================
call 05\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 11/21 05\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 12/21 06\ 周期6 EMS 状态机 (g++)
echo ============================================
call 06\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 13/21 06\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 14/21 07\ 周期7 实时控制闭环 (g++)
echo ============================================
call 07\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 15/21 07\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 16/21 08\ 周期8 优化调度与实时控制协同 (g++)
echo ============================================
call 08\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 17/21 08\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 18/21 07\ 产品化 P0/P0.5 设备 I/O 抽象测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 19/21 09\ 周期9 多策略组合测试 (闭环时序级) (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 20/21 10\ 周期10 EMS 24h 离线仿真测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 21/21 P1\ 产品化 P1 配置化 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
if "%FAIL%"=="1" (
    ...
    echo [BUILD ALL OK] All 21 components built.
    popd
    endlocal
    exit /b 0
)
