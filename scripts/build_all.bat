...
echo.
echo ============================================
echo 1/20 01\  B组 strategy server (gcc)
echo ============================================
call 01\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 2/20 02\  A组 safety mgr demo (g++)
echo ============================================
call 02\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 3/20 02\  A组 safety unit tests (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 10/20 05\ 周期5 安全约束引擎 (g++)
echo ============================================
call 05\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 11/20 05\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 12/20 06\ 周期6 EMS 状态机 (g++)
echo ============================================
call 06\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 13/20 06\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 14/20 07\ 周期7 实时控制闭环 (g++)
echo ============================================
call 07\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 15/20 07\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 16/20 08\ 周期8 优化调度与实时控制协同 (g++)
echo ============================================
call 08\scripts\build.bat || set FAIL=1
echo.
echo ============================================
echo 17/20 08\ 单元测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 18/20 07\ 产品化 P0/P0.5 设备 I/O 抽象测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 19/20 09\ 周期9 多策略组合测试 (闭环时序级) (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
echo.
echo ============================================
echo 20/20 10\ 周期10 EMS 24h 离线仿真测试 (g++)
echo ============================================
if "%BUILD_TESTS%"=="1" (
...
if "%FAIL%"=="1" (
    ...
    echo [BUILD ALL OK] All 20 components built.
    popd
    endlocal
    exit /b 0
)
